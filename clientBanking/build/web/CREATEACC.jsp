                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                <form method="post" action="createNewAccount" class="form-horizontal" id="sample-form">
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="FNAME" name="FNAME"  class="width-100" required="true"/>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="MNAME" name="MNAME" class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="LNAME" name="LNAME"  class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="ADDRESS" name="ADDRESS" class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="NATIONALITY" NAME="NATIONALITY" class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" id="OCCUPTION" name="OCCUPTION" class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" name="BRANCH" id="BRANCH" class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="ACCTYPE" id="ACCTYPE">
                                                ...
                                                <option value="F">INTEREST FREE</option>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" name="BALANCE" id="BALANCE" class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" name="PNUM" id="PHONENUMBER" class="width-100" required="true"/>
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    </div>
