                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                                    ...
                                    <div class="ace-settings-item">
                                        <div class="pull-left">
                                            <select id="skin-colorpicker" class="hide">
                                                <option data-skin="no-skin" value="#438EB9">#6e5773</option>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                <form method="post" action="addemployee" class="form-horizontal" id="sample-form">
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <div class="col-xs-12 col-sm-5">
                                            <span class="block input-icon input-icon-right">
                                                <input type="text" name="PNUM" id="PHONE NUMBER" class="width-100" />
                                                <i class="ace-icon fa fa-check-circle"></i>
                                            </span>
                                        </div>
                                    </div>
