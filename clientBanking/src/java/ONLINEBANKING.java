...
import entity.News;
import entitis.Transaction;

import java.rmi.Remote;
import java.rmi.RemoteException;
import java.util.List;
import thealeke.Account;
import thealeke.Employee;

public interface ONLINEBANKING extends Remote {
   public int createAccount(String FNAME, String MNAME, String LNAME, String ADDRESS, String ACCTYPE, String OCCUPTION, String DISTRICT, 
            String BRANCH, double BALANCE, String PNUM, String PHOTO, String GENDER, String NATIONALITY, int STATUS, int empId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public int transfer(int amount, String amount2, String s_branch, String s_firstname, String s_middlename, String s_lastname, String s_address, String date, 
            String r_firstname, String r_middlename, String r_lastname, String r_address, String r_phone, String r_branch, int emp_id, int status) throws RemoteException;
