    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
          ...
          PrintWriter out = response.getWriter();
           ...
           Thealekeweb_Service service = new Thealekeweb_Service();//connecting to the RPCwebservice to call login methode
            ...
            thealeke.Employee tr = proxy.checkEmployee(search);
          ...
          if(tr.getStatus() == 1)
            ...
            out.print("<div class=\"main-content\">\n"
                    ...
                    + "														<span class=\"editable\" id=\"username\">" + tr.getUserinfo().getFirstname()+ " " +tr.getUserinfo().getMiddlename()+" "+tr.getUserinfo().getLastname()+"</span>\n"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "\n"
                    + "												<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getUserinfo().getOccupation()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getAddressinfo().getDistrict()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getAddressinfo().getBranch()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "\n" + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getDates()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    + "													<div class=\"profile-info-name\">NATIONALITIY</div>\n"
                    + "\n"
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getAddressinfo().getNationality()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "														<span class=\"editable\" id=\"country\">" + tr.getUserinfo().getGender()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														<i class=\"fa fa-map-marker light-orange bigger-110\"></i>\n"
                    + "														<span class=\"editable\" id=\"country\">" + tr.getUserinfo().getPhoneNo()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" +status+ "</span>\n"
                    + "														"
                    + "													</div>\n"
