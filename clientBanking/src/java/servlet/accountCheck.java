...
public class accountCheck extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int accnum = Integer.parseInt(request.getParameter("search"));
        
        PrintWriter out = response.getWriter();
        if(request.getSession().getAttribute("role").equals("client")){
            out.print("<h2>Not autherized for search question<h2>");
        }else{
            ...
            if(a.getUserinfo().getGender().equals("Female"))        
                out.print("													<img id=\"avatar\" class=\"editable img-responsive\" alt=\"Alex's Avatar\" src=\"assets/images/avatars/girl.jpg\" width=300px />\n");
            else        
                out.print("													<img id=\"avatar\" class=\"editable img-responsive\" alt=\"Alex's Avatar\" src=\"assets/images/avatars/avatar-male.jpg\" width=300px />\n");
                ...
                out.print("No user with this account");
            }
        }
    }
}