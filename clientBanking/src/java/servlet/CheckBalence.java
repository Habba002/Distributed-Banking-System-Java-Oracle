...
public class CheckBalence extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getSession().getAttribute("role") == null)
            ...
            if(a.getUserinfo().getGender().equals("FEMALE"))        
                out.print("													<img id=\"avatar\" class=\"editable img-responsive\" alt=\"Alex's Avatar\" src=\"assets/images/avatars/avatar1.png\" width=300px />\n");
            else        
                out.print("													<img id=\"avatar\" class=\"editable img-responsive\" alt=\"Alex's Avatar\" src=\"assets/images/avatars/profile-pic.jpg\" width=300px />\n");
                    ...
                    + "															&nbsp;\n"
                    + "															<span class=\"white\">" + a.getUserinfo().getFirstname()+ " " + a.getUserinfo().getLastname()+ "</span>\n"
                    + "														</a>\n"
                    + "\n"
                    + "													\n"
                    + "													</div>\n"
                    ...
                    + "														<span class=\"editable\" id=\"username\">" + a.getAccountNo()+ "</span>\n"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "\n"
                    + "												<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + a.getUserinfo().getFirstname()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + a.getUserinfo().getMiddlename()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "\n" + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + a.getUserinfo().getLastname()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + a.getUserinfo().getGender()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "														<span class=\"editable\" id=\"country\">" + a.getAddressinfo().getAddress()+ "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														<i class=\"fa fa-map-marker light-orange bigger-110\"></i>\n"
                    + "														<span class=\"editable\" id=\"country\">" + a.getAddressinfo().getNationality() + "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + a.getUserinfo().getOccupation() + "</span>\n"
                    + "														"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														"
                    + "														<span class=\"editable\" id=\"country\">" + a.getDates()+ "</span>\n"
                    + "														 "
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														<i class=\"fa fa-map-marker light-orange bigger-110\"></i>\n"
                    + "														<span class=\"editable\" id=\"country\">" + a.getAddressinfo().getDistrict()+ "</span>\n"
                    + "														 "
                    + "													</div>\n"
                    + "												</div>\n"
                    + "<div class=\"profile-info-row\">\n"
                    ...
                    + "													<div class=\"profile-info-value\">\n"
                    + "														<i class=\"fa fa-map-marker light-orange bigger-110\"></i>\n"
                    + "														<span class=\"editable\" id=\"country\">" + a.getAddressinfo().getBranch()+ "</span>\n"
                    + "														 "
                    + "													</div>\n"
                    + "												</div>\n"
                    + "												<div class=\"profile-info-row\">\n"
                    ...
                    + "\n"
                    + "													<div class=\"profile-info-value\">\n"
                    + "														<span class=\"editable\" id=\"age\">" + a.getUserinfo().getPhoneNo() + "</span>\n"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "\n"
                    + "												<div class=\"profile-info-row\">\n"
                    ...
                    + "\n"
                    + "													<div class=\"profile-info-value\">\n"
                    + "														<span class=\"editable\" id=\"signup\">" + a.getAccountType()+ "</span>\n"
                    + "													</div>\n"
                    + "												</div>\n"
                    + "\n"
                    + "												<div class=\"profile-info-row\">\n"
